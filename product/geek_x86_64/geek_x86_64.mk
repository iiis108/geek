...
#引用预制mk文件
$(call inherit-product-if-exists, vendor/geek/preinstall/preinstall.mk)

# Overrides
PRODUCT_BRAND := Android
PRODUCT_NAME := sdk_phone_x86_64
PRODUCT_DEVICE := geek_x86_64
...
# config selinux
SYSTEM_EXT_PUBLIC_SEPOLICY_DIRS += vendor/geek/sepolicy/public
SYSTEM_EXT_PRIVATE_SEPOLICY_DIRS += vendor/geek/sepolicy/private
BOARD_SEPOLICY_DIRS += vendor/geek/sepolicy/vendor
